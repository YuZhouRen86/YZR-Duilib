...
void Window::PhysicalToLogicalPoint(UiPoint& pt) const {
	PhysicalToLogicalPoint(m_hWnd, pt);
}

void Window::PhysicalToLogicalPoint(HWND hWnd, UiPoint& pt) const {
	POINT ptLogical = { pt.x, pt.y };
	PhysicalToLogicalPointWrapper(m_hWnd, &ptLogical);
	pt = UiPoint(ptLogical.x, ptLogical.y);
}
